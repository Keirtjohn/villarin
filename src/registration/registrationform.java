...
public class registrationform extends javax.swing.JFrame {
    ...
    public boolean duplicateCheck(){
        ...
        try{ 
             String query = "SELECT * FROM tbl_2  WHERE u_username = '" + uname.getText() + "' OR u_email = '" + email.getText() + "'";
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 20, 312, 55));
    ...
    private void register1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_register1ActionPerformed
       ...
       if(fname.getText().isEmpty() || lname.getText().isEmpty()||email.getText().isEmpty()||uname.getText().isEmpty()
        ...
        if(dbc.insertData("INSERT INTO tbl_2 "
